...
//  Sesion8
//
//  Created by Mauricio García S on 27/11/22.
//
...
public class DataManager {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        let options: NSDictionary = [ EncryptedStore.optionPassphraseKey() : "123",
                        EncryptedStore.optionFileManager(): EncryptedStoreFileManager.default() ]
        
        let descriptions = try! EncryptedStore.makeDescription(options: options as! [AnyHashable: Any], configuration: nil)
